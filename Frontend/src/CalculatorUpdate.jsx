...
// Neccessary to fetch productId from the URL
...
const CalculatorUpdate = () => {
  // Fetches the productId from the URL
  ...
  // Fetches the product with given productId from the API, and sets the product state
  useEffect(() => {
  ...
  */
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await ProductService.updateProduct(productId, updatedProduct);//product);
