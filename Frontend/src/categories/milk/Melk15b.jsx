...
import {ResultEfsaFulfilled, ResultEfsaNotFulfilled} from '../../ResultEfsaClaims'; // EFSA claims
...
const Melk15b = ({ product, handleNutrientChange, onNutritionChange, onCalculationComplete, hasNokkelhullet, hasEfsaNutrition }) => {
