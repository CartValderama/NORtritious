...
const Melk11a = ({ product, handleNutrientChange, onNutritionChange, onCalculationComplete, hasNokkelhullet, hasEfsaNutrition, vitaminClaims, mineralClaims, selectedVitamins, selectedMinerals, otherClaims, selectedOthers }) => {
 ...
 const changeHandle = (event) => {
  ...
  {buttonClicked && showResults && showNokkelhulletResults ? (
    ...
    <ResultNokkelhulletFulfilled category={"Melk11a"} className="container nøkkelhullet-food-result-container">
