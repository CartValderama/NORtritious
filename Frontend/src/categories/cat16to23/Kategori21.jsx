...
const Kategori21 = ({ product, handleNutrientChange, onNutritionChange, onCalculationComplete, hasNokkelhullet, hasEfsaNutrition, vitaminClaims, mineralClaims, selectedVitamins, selectedMinerals  }) => {
  ...
  */
  ...
  const changeHandle = (event) => {
    ...
    setNutrition((prevNutrition) => {
     ...
     onNutritionChange(updatedNutrition);
      ...
      useEffect(() => {
        checkClaims(claims);
      }, [ lowFat, fatFree, lowSaturatedFat, lowSugars, sugarsFree, withNoAddedSugars]);
  ...
  const onClick = (e) => {
    ...
    ----------------------------------------------------
    */
    // Claim: "LOW FAT", "FAT-FREE" "LOW SATURATED FAT", "LOW SUGARS", "SUGARS-FREE", AND "WITH NO ADDED SUGARS"
