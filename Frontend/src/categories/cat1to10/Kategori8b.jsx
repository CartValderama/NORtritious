...
const Kategori8b = ({ product, handleNutrientChange, onNutritionChange, onCalculationComplete, hasNokkelhullet, hasEfsaNutrition, vitaminClaims, mineralClaims, selectedVitamins, selectedMinerals, otherClaims, selectedOthers }) => {
 ...
 const changeHandle = (event) => {
  ...
  setNutrition((prevNutrition) => {
   ...
   onNutritionChange(updatedNutrition);
    ...
    useEffect(() => {
      checkClaims(claims);
    }, [lowEnergy, lowFat, fatFree, lowSaturatedFat, saturatedFatFree, lowSugars, sugarsFree, withNoAddedSugars, highFibre, sourceOfProtein]);
  ...
  {buttonClicked && showResults && showNokkelhulletResults ? (
    ...
    <ResultNokkelhulletFulfilled category={"Kategori8b"} className="container nøkkelhullet-food-result-container">
