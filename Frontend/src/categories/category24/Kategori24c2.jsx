...
const Kategori24c2 = ({ product, handleNutrientChange, onNutritionChange, onCalculationComplete, hasNokkelhullet, hasEfsaNutrition }) => {
  ...
  */
  ...
  {buttonClicked && showResults && showNokkelhulletResults ? (
    ...
    <ResultNokkelhulletFulfilled category={'Kategori24c2'} className="container nøkkelhullet-food-result-container">
