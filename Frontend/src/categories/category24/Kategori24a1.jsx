...
const Kategori24a1 = ({ product, handleNutrientChange, onNutritionChange, onCalculationComplete, hasNokkelhullet, hasEfsaNutrition, vitaminClaims, mineralClaims, selectedVitamins, selectedMinerals, otherClaims, selectedOthers }) => {
  ...
  */
  ...
  {buttonClicked && showResults && showNokkelhulletResults ? (
    ...
    <ResultNokkelhulletFulfilled category={'Kategori24a1'} className="container nøkkelhullet-food-result-container">
