...
const Kategori32 = ({ product, handleNutrientChange, onNutritionChange, onCalculationComplete, hasNokkelhullet, hasEfsaNutrition, vitaminClaims, mineralClaims, selectedVitamins, selectedMinerals, otherClaims, selectedOthers }) => {
  ...
  const changeHandle = (event) => {
    ...
    setNutrition((prevNutrition) => {
     ...
     onNutritionChange(updatedNutrition);
      ...
      useEffect(() => {
        checkClaims(claims);
      }, [lowSaturatedFat, saturatedFatFree, lowSugars, sugarsFree, withNoAddedSugars]);
 ...
 /*
    ...
    ----------------------------------------------------
    */
    // Claim: "LOW SUGARS", "SUGARS-FREE", "LOW SATURATED FAT", AND "SATURATED FAT-FREE"
