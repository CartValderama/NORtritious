...
const Kategori25a = ({ product, handleNutrientChange, onNutritionChange, onCalculationComplete, hasNokkelhullet, hasEfsaNutrition, vitaminClaims, mineralClaims, selectedVitamins, selectedMinerals, otherClaims, selectedOthers  }) => {
  ...
  /**
   * Previously implemented, not touched. 
   */
 ...
 const changeHandle = (event) => {
  ...
  setNutrition((prevNutrition) => {
   ...
   onNutritionChange(updatedNutrition);
    ...
    useEffect(() => {
      checkClaims(claims);
    }, [lowEnergy, lowFat, lowSaturatedFat, saturatedFatFree, lowSugars, sugarsFree, withNoAddedSugars]);
  ...
  const onClick = (e) => {
    ...
    ----------------------------------------------------
    */
    // Claim: "LOW SUGARS", "SUGARS-FREE", "LOW ENERGY", "LOW FAT", "LOW SATURATED FAT", AND "SATURATED FAT-FREE"
          ...
          >
            ...
            <div className="row">
              <div className="col-md-10">
                ...
                <ResultComponents.ClaimSaturatedFatFreeResult saturatedFatFree={saturatedFatFree}/>
