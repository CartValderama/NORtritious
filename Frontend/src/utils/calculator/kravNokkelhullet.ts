interface KategoriKrav {
  fett: string | null;
  mettede: string | null;
  sukkerarter: string | null;
  tilsattSukkerarter: string | null;
  kostfiber: string | null;
  salt: string | null;
  [key: string]: string | null;
}

const kategorier: Record<string, KategoriKrav> = {
    'Kategori1': {
...
export interface NokkelhulletThreshold {
  maxFat?: number;
  maxSatFat?: number;
  dynamicSatFatFraction?: number;
  maxTotalSugars?: number;
  maxAddedSugars?: number;
  minFibre?: number;
  maxSalt?: number;
}
...
export const nokkelhulletThresholds: Record<string, NokkelhulletThreshold> = {
