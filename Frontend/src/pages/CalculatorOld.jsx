...
import ProductButtons from "../components/calculator/old/ProductButtons";
import NutritionForm from "../components/calculator/old/NutritionForm";
import NutritionResult from "../components/calculator/old/NutritionResult";
import EfsaHealthClaimsPanel from "../components/calculator/old/EfsaHealthClaimsPanel";
import ProductInfoSection from "../components/calculator/old/ProductInfoSection";
import { useCalculatorState } from "../hooks/calculator/useCalculatorState";
import efsaLogo from "../assets/img/efsaLogo.png";

// "Old" calculator — styled after the pre-rewrite per-category calculator:
// table-based nutrition input and a two-column (form left, results right)
// layout with solid green/red result boxes, instead of the "new" design's
// card-based single-column layout (see CalculatorNew.jsx).
...
const CalculatorOld = () => {
  ...
  return (
    <form onSubmit={handleSubmit}>
      <div className="calculator d-flex flex-column gap-5 pb-5 container py-4">
