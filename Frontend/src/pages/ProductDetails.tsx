...
import { Product } from "../utils/types/product"; // Importer Product-typen
import SplitHtml from "../components/products/SplitHtmlProps";
import NutritionClaimsUL from "../components/products/NutritionClaimsUL";
import ClaimsLabels from "../components/products/ClaimsLabels";
import ProductActions from "../components/products/ProductActions";
import { deleteProduct, fetchProductById } from "../services/productService";
import HealthClaimsUL from "../components/products/HealthClaimsUL";
