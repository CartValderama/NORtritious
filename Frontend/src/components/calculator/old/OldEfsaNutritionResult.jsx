...
// OldNokkelhulletResult. Same underlying data (CLAIMS_CONFIG, result.efsaNutritionClaims)
// as the current design's EfsaSection.jsx.
const OldEfsaNutritionResult = ({ result, foodType }) => {
        ...
        <div className="d-flex align-items-start justify-content-between gap-2">
          ...
          >
            {showDemoClaims
              ...
              : `+${Math.max(0, DEMO_CLAIM_TARGET - realClaims.length)} demo-påstander`}
          </button>
        </div>
      )}
      {isExpanded && (
...
export default OldEfsaNutritionResult;
