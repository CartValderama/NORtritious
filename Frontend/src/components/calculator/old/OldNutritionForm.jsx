...
import OldNutritionFieldTable from "./OldNutritionFieldTable";
import {
  EMPTY_NUTRITION,
...
// table-based field input (OldNutritionFieldTable) instead of the card grid, and
// old-style Beregn/Nullstill buttons sitting directly under the table.
const OldNutritionForm = ({
  category,
  foodType,
  totalStarch,
  resistantStarch,
...
export default OldNutritionForm;
